...
Since this project functions as a "factory app" for **smart_learn**, we exclusively employ the "esptool" to flash the binaries. Checkout the [partition table](../partitions.csv)
...
Check the [original implementation of Tinyuf2](https://github.com/espressif/esp-iot-solution/tree/master/components/usb/esp_tinyuf2) for more information. For more details of follow the [smart_learn](../README.md) project. 