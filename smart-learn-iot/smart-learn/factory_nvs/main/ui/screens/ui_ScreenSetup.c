...
void ui_ScreenSetup_screen_init(void)
{
    ...
    // Use theme color background instead of image - dark blue gradient effect
    lv_obj_set_style_bg_color(ui_ScreenSetup, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ScreenSetup, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_ScreenSetup, lv_color_hex(0x1a1a2e), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_ScreenSetup, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Replace text background image with semi-transparent overlay using theme colors
    ui_ImageSetupTextBg = lv_obj_create(ui_ScreenSetup);
    ...
    lv_obj_set_style_bg_color(ui_ImageSetupTextBg, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ImageSetupTextBg, 100, LV_PART_MAIN | LV_STATE_DEFAULT); // Semi-transparent
    lv_obj_set_style_radius(ui_ImageSetupTextBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_ImageSetupTextBg, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_LabelSetupStepContent,
                      "1. Connect ESP-Box to PC.\n2. Open \"ESP-Box\" folder.\n3. Edit \"CONFIG.INI\" file with Wi-Fi SSID, password, OpenAI key, Base URL, and KB URL (knowledge base URL).\n4. Save the file.\n5. Restart the device.");
    ...
    lv_obj_set_style_bg_color(ui_ButtonSetup, lv_color_hex(0x04B900), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelSetupBtn, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
