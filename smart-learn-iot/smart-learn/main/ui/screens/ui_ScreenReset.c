...
void ui_ScreenReset_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_ScreenReset, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ScreenReset, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_ScreenReset, lv_color_hex(0x1a1a2e), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_ScreenReset, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_ButtonResetConfirm, lv_color_hex(0x04B900), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelSetupBtn2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui_ImageResetBack, lv_color_hex(0xA0CCE5), LV_PART_MAIN | LV_STATE_DEFAULT);
