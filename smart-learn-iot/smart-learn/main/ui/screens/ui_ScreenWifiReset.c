...
void ui_ScreenWifiReset_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_ScreenWifiReset, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ScreenWifiReset, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_ScreenWifiReset, lv_color_hex(0x1a1a2e), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui_ScreenWifiReset, LV_GRAD_DIR_VER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_ButtonWifiResetConfirm, lv_color_hex(0x04B900), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelSetupBtn1, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui_ImageWifiResetBack, lv_color_hex(0xA0CCE5), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_LabelWifiResetContent,
                      "1. Press the \"OK\" button to enter factory reset mode.\n2. Connect the box to your PC and add the OpenAI key, Wi-Fi credentials, Base URL, and KB URL (knowledge base URL).\n3. Follow the on-screen prompts to complete the setup process.");
